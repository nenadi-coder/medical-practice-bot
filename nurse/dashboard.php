...
// Handle status updates - WITH FILTER PRESERVATION
if (isset($_GET['action']) && isset($_GET['id'])) {
    ...
    // FIXED: Preserve filter on redirect
...
// FIXED: Added a.send_sms to SELECT query
if ($filter == 'all') {
...
<body>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-card"><div class="stat-number"><?php echo $stats['total']; ?></div><div class="stat-label"><i class="fas fa-calendar-day"></i> Total Today</div></div>
            <div class="stat-card"><div class="stat-number"><?php echo $stats['scheduled']; ?></div><div class="stat-label"><i class="fas fa-clock"></i> Scheduled</div></div>
            <div class="stat-card"><div class="stat-number"><?php echo $stats['confirmed']; ?></div><div class="stat-label"><i class="fas fa-check-circle"></i> Confirmed</div></div>
            ...
            <div class="stat-card"><div class="stat-number"><?php echo $stats['cancelled']; ?></div><div class="stat-label"><i class="fas fa-ban"></i> Cancelled</div></div>
        </div>
